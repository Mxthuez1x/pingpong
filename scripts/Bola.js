class Bola{ 
    constructor(c,pad){
        ...
        this.ouro = new Image ();
        this.ouro.src = "assets/ouro.png";
        this.ouro.width=40;
        this.ouro.height=40;
        this.ouro.addEventListener('load',()=>{
           this.draw()})
    ...
    management(){
        ...
        resetBall()
        {
            ...
            this.y=(this.c.canvas.height/2)-(this.altura/2);
            pad.x=5;
            pad.y=(this.c.canvas.height/2)-(this.pad.altura/2);
    ...
    draw(){
        ...
        this.c.drawImage(this.ouro, this.x, this.y, this.ouro.width, this.ouro.height);
    }
