class Cpu {
    constructor(c, bola) {
        ...
        this.cr77 = new Image ();
        this.cr77.src = "assets/cr77.png";
        this.cr77.width=100;
        this.cr77.height=100;
        this.cr77.addEventListener('load',()=>{
           this.draw()})
    ...
    management() {
        ...
        draw(){
            this.management();
            this.c.drawImage(this.cr77, 910, this.y, this.cr77.width, this.cr77.height);
